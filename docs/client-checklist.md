...
| Signed lease and lease-date source | Identify the exact system, sheet, tab, column, screen, or document where signed leases and lease end dates live.                                                                                   | Lease Renewal Agent first authoritative trigger.    | Included in the walkthrough checklist; awaiting Dan/team answer.                                                                  | Source system classified as read-only/write-capable/blocked.                      |
