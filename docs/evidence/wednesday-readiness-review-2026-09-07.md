...
| Seven live-source browser smokes              | Pending                                                                              | ADC works; desk, guide, Dashboard, maintenance blockers, intake, navbar and theme still need the live-source run |
...
| Watcher host                                  | Running after 16:41:36Z recovery; inherited main refused as foundation_not_in_target | Earlier Windows launcher exit remains unexplained; new code/config must be picked up safely                      |
| CI and candidate lifecycle                    | Pending exact-SHA push evidence                                                      | No new readiness candidate or promotion claimed                                                                  |
| Managed-browser receipt and observation       | Pending                                                                              | Existing Admin/Editor on both origins, fresh receipt, exact promotion and 300,000 ms observation required        |
