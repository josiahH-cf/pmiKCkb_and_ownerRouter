...
| Production        | PMI KC-owned live product environment.     | pmi-kc-kb-prod (#558870356522); bucket pmi-kc-kb-prod-sources-558870356522; data store kb-lease-renewals-txt. | Client Secret Manager or workload ID.   | Client TBD               | Provisioned 2026-06-19 under org pmikcmetro.com: billing linked + $10 budget alert, 19 APIs, Firestore + 12 spaces, Firebase web app 1:558870356522:web:c1b2473b886a6edd889953, bucket pmi-kc-kb-prod-sources-558870356522, Agent Search kb-lease-renewals-txt (3 docs). Live smoke:ask-live PASS. Pending: Google sign-in toggle + deploy; Firestore rules deploy. | Production preflight and cutover smoke.           |
