...
| Production        | PMI KC-owned live product environment.     | TBD client project/domain/source maps.  | Client Secret Manager or workload ID.   | Client TBD               | Owner creating fresh project under org pmikcmetro.com (584930494337) + PM billing in console (2026-06-19); awaiting project id. | Production preflight and cutover smoke.           |
