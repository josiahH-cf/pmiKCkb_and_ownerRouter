...
| Production        | PMI KC-owned live product environment.     | TBD client project/domain/source maps.  | Client Secret Manager or workload ID.   | Client TBD               | Project pmi-kc-kb-prod (number 558870356522) created under org pmikcmetro.com 2026-06-19; billingEnabled=false. Blocked: PM must link billing 01A5A3-65CA5A-614D45 (or grant josiah@pmikcmetro.com roles/billing.user) + add a $10 project-scoped budget alert. | Production preflight and cutover smoke.           |
