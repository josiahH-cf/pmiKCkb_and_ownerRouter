...
| Production        | PMI KC-owned live product environment.     | TBD client project/domain/source maps.  | Client Secret Manager or workload ID.   | Client TBD        | Billing provisioned 2026-06-19; project id TBD (create/select + link billing + $10 alert). | Production preflight and cutover smoke.           |
