...
assertions remain intact. The full local verify script passes. B-AUTH2 still requires elapsed-session
and managed-browser release acceptance; local CLI/ADC reads work after reboot. No readiness
deployment or promotion is yet verified. See `docs/evidence/wednesday-readiness-review-2026-09-07.md`.
...
Current S106/S34/S100/S98/S108/S110 fixes are local and unreleased; this does not promote any row.
