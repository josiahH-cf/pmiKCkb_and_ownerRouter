...
|    16 | S106 — Dotloop connection and renewal readiness — **COMMITTED / CANDIDATE-DEPLOYED; live check BLOCKED (R5)**                                                    | Independent                            | Fake-provider connect/deny/expire/refresh/revoke/reconnect matrix, selection record, readiness projection green; the runtime token provider and Connection Center wiring are outstanding; live check `BLOCKED` only on the owner's OAuth app and account.                                                                                                                    |
...
| S34   | `docs/feature-suites/dotloop-esign-activation.md`                          | Rewritten 2026-09-03 as the Dotloop renewal packet lifecycle; committed and carried by the current unpromoted zero-traffic candidate named in `docs/facts.md` F-CANDIDATE; runtime wiring and live proof outstanding                                                   |
...
| S106  | `docs/feature-suites/dotloop-connection-and-readiness.md`                  | Committed and carried by the current unpromoted zero-traffic candidate named in `docs/facts.md` F-CANDIDATE; OAuth connection, selection, and readiness against the provider fake; runtime token provider and Connection Center wiring outstanding; live check blocked |
