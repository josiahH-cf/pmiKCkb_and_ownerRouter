...
|    13 | S103 — Lease term and renewal eligibility — **IMPLEMENTED / UNRELEASED (R2)**                                                                                    | S102                                   | Term projection, audited term review record, `periodic_review` disposition, desk/workspace/query term display, and assistant reuse green; no provider write.                                                                                                                                                      |
