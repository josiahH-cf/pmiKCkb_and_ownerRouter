...
|    17 | S34 — Dotloop renewal packet lifecycle — **IMPLEMENTED / UNRELEASED; live proof BLOCKED (R6)**                                                                   | S105, S106, S66 catalog                | Provider over the official API, one loop per packet hash, readback, refresh, and signature handoff green through fakes; live proof and key activation remain owner-gated.                                                                                                                                         |
