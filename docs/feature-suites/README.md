...
|    14 | S104 — Renewal desk and workspace parity closure — **IMPLEMENTED / UNRELEASED (R3)**                                                                             | S102, S103                             | Table/workspace parity and open/write/return continuation proofs green; S82 preservation green.                                                                                                                                                                                                                   |
