...
| S114  | `docs/feature-suites/renewal-lease-information-and-process-sidebars.md`    | IMPLEMENTED at 24b0be59 (feature 1 of 7 in renewal-operator-hub-v1); full gate, core E2E and both compiled browser checks green on b29185a3; first release attempt rolled back (observer runtime, not code); release resumed on the native watcher.                |
