...
|    12 | S102 — Tenant current rent from the active RentVine lease — **SPEC ONLY (renewal-completion R1)**                                                                | S82 remediation released               | Lease-detail `baseRentAmount` drives every consumer, unit rent is a labelled reference, null/discrepancy/refresh behavior preserved; focused, canonical, and rehearsal-browser gates green.                                                                                                                       |
|    13 | S103 — Lease term and renewal eligibility — **SPEC ONLY (R2)**                                                                                                   | S102                                   | Term projection, audited term review record, `periodic_review` disposition, desk/workspace/query term display, and assistant reuse green; no provider write.                                                                                                                                                      |
|    14 | S104 — Renewal desk and workspace parity closure — **SPEC ONLY (R3)**                                                                                            | S102, S103                             | Table/workspace parity and open/write/return continuation proofs green; S82 preservation green.                                                                                                                                                                                                                   |
|    15 | S105 — End-to-end renewal lifecycle closure — **SPEC ONLY (R4)**                                                                                                 | S102-S104                              | Typed owner outcomes, version-binding audit, and the fixed-term lifecycle plus branch fixtures green through owning services.                                                                                                                                                                                     |
|    16 | S106 — Dotloop connection and renewal readiness — **SPEC ONLY (R5)**                                                                                             | Independent                            | Fake-provider connect/deny/expire/refresh/revoke/reconnect matrix, selection record, readiness projection, and health wiring green; live check `BLOCKED` only on the owner's OAuth app and account.                                                                                                               |
...
| S102  | `docs/feature-suites/tenant-current-rent-source.md`                        | Specified 2026-09-03; lease-scoped current rent from the RentVine lease detail is not implemented |
