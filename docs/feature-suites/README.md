...
| S55 Service rename + identifier cleanup     | `docs/feature-suites/production-service-rename-and-identifier-cleanup.md` | Spec — D56 rename; retires after cutover                     |
| S56 Production Live-only, Test lane retired | `docs/feature-suites/production-live-only-test-lane-retirement.md`        | Spec — owner-scoped; supersedes the S40 migrate-to-Demo plan |
...
Production dual-lane behavior remains truthful until S40 completes its backed-up migration and
owner-run cutover.
