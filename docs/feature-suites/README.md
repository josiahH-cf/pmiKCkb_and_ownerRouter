...
|     2 | S85 — Global theme and visual system — **COMPLETE**                        | S96                                  | Technical implementation `ALL_GATES_GREEN`; separate `brand_conformance: BLOCKED` is recorded without claiming official brand.                                                                                                                                                                                                                                      |
