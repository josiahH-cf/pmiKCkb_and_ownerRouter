...
| ---- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `L`  | A named read or action is actually in flight.                                                                       | `Loading {surfaceLabel}…` or `{actionLabel}…`; never a percentage without exact completed/total truth.                            | No recovery while pending. S86 resolves to success, `X`, `U`, or `A`; navigation cannot imply cancellation.             |
