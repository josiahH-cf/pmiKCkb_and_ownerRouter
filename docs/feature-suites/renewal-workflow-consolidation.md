...
S117 hosts this editor, the future-rent control and both provider review panels inside the Rent and
charges working area, with a per-destination status list beside them.
...
| ------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Correct current base-rent billing                                                                                                          | Update the selected current rent-account recurring charge with rentvine.lease.recurring_charge.update.                             | Resolve account.isRent, current schedule and charge identity. Never divide an aggregate among several charges automatically. After success the refreshed contractual base rent is compared with the charge; a remaining difference is surfaced as a fresh mismatch (S117). Read charge detail and refreshed lease detail; report charge success and any unresolved displayed-base-rent discrepancy separately. |
...
grant roles to remove it. S117 gives RentVine intents the same visible pending, prepared, applied
and read-back states, and holds a future-rent confirmation until the tenant's acceptance of the exact
terms is recorded.
