...
Contacts, the current rent decision, the reviewed comparison and your retained sender signature
are filled from their sources; each filled value shows where it came from. **N inputs remain for
final use** lists every genuine gap with a link to the control, section or Connections entry that
resolves it; **Review missing inputs** opens that list. **Copy formatted body** and **Copy plain
text** open only once the list is empty and the preparation is reviewed; the subject stays copyable
on its own. If clipboard access fails for a ready body, the selectable plain text remains
available. Plain text can be pasted into the appropriate manual portal or text channel after
review. The copy actions sit beside the RentVine messages links for that audience; **Preview
unsent Gmail draft** and the Gmail Drafts folder link form their own group, and Gmail readiness
never blocks local copy. **Preview unsent Gmail draft** shows its exact recipients, subject,
...
| 26   | /connections               | Insurance flyer                               | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
| 27   | /connections               | Renewal information form                      | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
...
| 37   | /connections               | Approved standard lease location              | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
| 38   | /connections               | Approved renewal extension location           | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
| 39   | /connections               | Approved animal agreement location            | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
| 40   | /connections               | Approved lead-based-paint disclosure location | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
| 41   | /connections               | Approved city addendum location               | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
| 42   | /connections               | Approved HOA artifact location                | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
| 43   | /connections               | Approved owner acknowledgment location        | label    | region:Renewal resource links                     | required     | Persistent labeled blank or reviewed location.                                                                                                |
