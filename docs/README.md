...
Use `docs/feature-suites/README.md`. It is the sole queue for the specified-but-unimplemented S36 and
S82-S100 initiative; S96 is the first executable suite. Completed
