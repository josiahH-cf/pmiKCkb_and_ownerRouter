// Automated-test contract for the retired Lease Renewal Test journey.
//
// Every alias below is invented and reserved. This helper is outside the application import graph;
// it preserves state-transition and evidence coverage without restoring a browser Test lane.
