...
describe("rollback plan", () => {
  ...
  it("accepts a recorded serving revision in the deploy-wrapper form", () => {
    ...
    const revision = "pmi-kc-kb-demo-rmrxpsn5q-92c1b759735e";
    expect(validatePriorRevision("pmi-kc-kb-demo", revision)).toBe(revision);
  });
  ...
  it("still refuses a revision that is not a real revision name for this service", () => {
    for (const candidate of [
      ...
      "   ",
      "pmi-kc-kb-demo",
      "pmi-kc-kb-demo-latest",
      "other-service-00041-abc",
      "other-service-rmrxpsn5q-92c1b759735e",
      // Right shape, wrong entropy width.
      "pmi-kc-kb-demo-rmrxpsn5q-92c1b759735",
      // Injection attempt riding along with a plausible revision.
      "pmi-kc-kb-demo-00041-abc=100 --to-revisions=attacker=100",
    ]) {
      expect(
        validatePriorRevision("pmi-kc-kb-demo", candidate),
