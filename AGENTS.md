...
Feature 3 implementation merged through PR #87; its zero-traffic candidate needs the corresponding
external-link reconciliation update on `codex/renewal-external-destination-assurance`.
