...
export const LEASE_EXECUTION_DEFINITIONS: readonly ExternalActionDefinition[] = [
  ...
  definition(
    ...
    "High",
    [],
    "Review the receipt and verified Sheet destination with an Admin for manual correction. Fixed-row operations are refused as provider_capability_unavailable until a stable-row seam exists.",
  ),
  definition(
