...
export function MaintenanceExecutionReadiness() {
  return (
    <ExternalExecutionReadiness
      ...
      introduction="Live actions use the configured provider gate with an exact action, target preview, human confirmation, receipt, and correction path. Provider proof comes only from a gated Live action."
